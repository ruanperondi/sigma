...
public final class ReflectionUtils {
  ...
  public static List<Field> getAllFields(List<Field> fields, Class<?> type) {
    return getAllFields(fields, type, true);
  }

  public static List<Field> getAllFields(List<Field> fields, Class<?> type, boolean recursive) {
    fields.addAll(Arrays.asList(type.getDeclaredFields()));

    if (recursive && type.getSuperclass() != null) {
