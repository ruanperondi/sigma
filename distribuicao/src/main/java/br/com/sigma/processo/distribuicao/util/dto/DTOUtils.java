  ...
  public static <DTO extends GenericDTO<?, ?>> void validateFiledsWithDTO(Class<DTO> dtoClass, String fieldsString) throws BusinessException {
    ...
    for (String string : fields) {
      ...
      if (CollectionUtils.isEmpty(collect)) {
        throw new BusinessException("Campo n�o encontrado: " + string + ". Campos permitidos: " + StringUtils.join(fieldList.stream().map(Field::getName).collect(Collectors.toList()).toArray(), ","));
      }
    }
