...
/**
 * Classe responsável por ter informações a respeito da Categoria
 */
@Entity
@Table
@DynamicUpdate
@SelectBeforeUpdate
@Audited
public class Categoria extends GenericPersistenceClass<Integer> {

  @Id
  @TableGenerator(name = "categoria_id", table = "sequence_ids", pkColumnName = "name", valueColumnName = "value")
  @GeneratedValue(strategy = GenerationType.TABLE, generator = "categoria_id")
  private Integer id;
  ...
  @Column(unique = true, nullable = false, length = 40)
  @NotBlank(message = "{categoria.id.externo.obrigatorio}")
