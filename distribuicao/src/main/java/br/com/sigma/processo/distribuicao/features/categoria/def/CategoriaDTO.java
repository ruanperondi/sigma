...
/**
 * Classe responsável por represntar um DTO da entidade de Categoria para trabalhar com o Front e o
 * Back
 *
 * @author Juan Perondi
 */
public class CategoriaDTO extends GenericDTO<Integer, Categoria> {
